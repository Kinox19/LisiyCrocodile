  ...
  return (
    <div className={s.main}>
      ...
      <div className={s.player__info}>
        <img className={s.current__image} src='https://i.ibb.co/qjjYkvC/cover-stroy.png'  alt='' />
    ...
    <div className={s.player__controlsMob}>
      <div className={s.player__controlsUpMob}>
        <img className={s.current__imageMob} src='https://i.ibb.co/qjjYkvC/cover-stroy.png'  alt='' />
