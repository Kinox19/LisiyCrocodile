      ...
      <div className={s.upperNav}>
        <div className={s.text__container}>
            ...
            <div className={s.twoTexts}>
              ...
              <p className={s.description_mob}>2021-2022 год – <br/>повышение ставок. Мы росли вместе со своей аудиторией,<br/> в следствие чего поставили цель значительно повысить<br/> качество звука.</p>
          ...
          {songslist.map((song, i) => (
            ...
            <li className={`${s.track__wrapper} ${currentSong === i ? `${s.selected}` : `${s.notSelected}`}`}
              ...
              <div className={s.leftSide}>
                ...
                <img src='https://i.ibb.co/qjjYkvC/cover-stroy.png' className={s.track__cover} onClick={() => {SetCurrent(i)}} alt='' />
              ...
              <div className={s.track__timeDownload}>
                ...
                <a href={song.downloadUrl} download>
                  <button className={s.control__download}>
                        <svg className={s.control__downloadSvg} viewBox="0 0 34 44" fill="none" xmlns="http://www.w3.org/2000/svg">
