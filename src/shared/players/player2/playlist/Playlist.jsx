      ...
      <div className={s.upperNav}>
        <div className={s.text__container}>
            ...
            <div className={s.twoTexts}>
              <p className={s.description}>2021-2022 год – повышение ставок. Мы росли<br></br> вместе со своей аудиторией, в следствие чего поставили цель значительно повысить качество звука.</p>
