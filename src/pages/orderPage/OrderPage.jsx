            ...
            {cartItems && cartItems.length ?(
                ...
                <div className={s.form__container}>
                    ...
                    <form className={s.inputs}>
                        <input className={s.input} type='text' required placeholder='ФИО:'></input>
                        <input className={s.input} type='email'required placeholder='Электронная почта:'></input>
                        <input className={s.input} type='tel'required placeholder='Контактный телефон:'></input>
                        <input className={s.input} type='text'required placeholder='Страна:'></input>
                        <input className={s.input} type='text'required placeholder='Город:'></input>
                        <input className={s.input} type='text'required placeholder='Адрес доставки:'></input>
